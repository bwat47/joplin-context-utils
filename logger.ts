 ...
 * console.contextUtils.setLogLevel(0) // DEBUG
 * console.contextUtils.setLogLevel(1) // INFO
 * console.contextUtils.setLogLevel(2) // WARN
 * console.contextUtils.setLogLevel(3) // ERROR
 * console.contextUtils.setLogLevel(4) // NONE
 * console.contextUtils.getLogLevel()  // get current log level
 */

const PREFIX = '[Context Utils]';

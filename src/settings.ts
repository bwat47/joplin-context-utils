...
const SETTINGS_CONFIG = {
    ...
    cleanUpListPaste: {
        ...
        description:
            'When pasting onto a line that already starts with a list marker (e.g. "- " or "- [ ] "), remove the list marker from the start of the pasted text. When pasting an ordered list onto an ordered list item, renumber the items that follow',
    },
